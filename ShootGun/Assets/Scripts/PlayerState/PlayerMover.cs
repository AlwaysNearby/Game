    ...
    public class PlayerMover : PlayerBaseState
    {
        ...
        public override void Start()
        {
            ...
            if (IsObstacleIn(direction))
            {
                ...
                AnimatorController.SetTrigger(ParameterPlayer.IsObstacle);
            }
            else
            {
                AnimatorController.SetBool(ParameterPlayer.Walk ,true);
        ...
        { 
            ...
            AnimatorController.SetBool(ParameterPlayer.Walk, false);
        }
